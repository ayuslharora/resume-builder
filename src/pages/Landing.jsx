...
export default function Landing() {
  ...
  return (
    <div className="landing-desktop-shell min-h-screen px-6 pt-6 pb-24 fade-in relative">
      ...
      <div className="w-full max-w-7xl relative z-10 flex flex-col gap-6 xl:gap-8">
